...
const MobileLayout = ({ children }: { children: React.ReactNode }) => {
	return (
		<div className='layout-main relative z-[0] grid grid-cols-[auto_1fr_auto] lg:block lg:pb-[70px]'>
			<Sidebar />
			<div className='layout-main__inner app-scrollbar h-screen overflow-y-auto lg:h-auto lg:overflow-visible'>
				<div className='layout-main__content min-h-screen pb-[30px]'>
					<Client>
						<FixedTopBar className='px-10' />
					</Client>
					<Header className='px-[40px] lg:pl-5 lg:pr-6 md:pr-3 sm:gap-0 sm:pl-2 sm:pr-1' />
