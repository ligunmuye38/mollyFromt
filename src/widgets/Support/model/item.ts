import { IProblemItem, ISupportItem } from './types'
		...
		messagesList: [
			{
				...
				name: 'Boface',
				message:
					'Aliquam erat volutpat. Sed odio ligula, faucibus vitae varius ut, bibendum quis sem. Phasellus nec lorem et erat varius finibus non vitae ante. Aenean sit amet imperdiet ligula, malesuada maximus dui.',
				type: 'default',
				timestamp: '15:28'
			},
			{
