...
const FaqBody = () => {
	return (
		<div className='flex h-auto w-full flex-col gap-4 px-5 md:px-0'>
			{faqDatas.map(item => {
				return (
					<Collapse
						header={item.title}
						...
						classNames={{
							...
							headerBase:
								'w-full h-auto py-5  rounded-lg px-5 flex items-center hover:cursor-pointer hover:bg-[#1a2030]',
							...
							content:
								'w-full text-[#545778] h-0 py-0 duration-300 transition-all ease-linear block overflow-hidden p-5',
