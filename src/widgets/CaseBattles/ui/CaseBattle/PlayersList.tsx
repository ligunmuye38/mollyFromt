...
const CircularBg = ({ className }: { className?: string }) => {
	return (
		<svg
			width='359'
			height='359'
...
const PlayersList = ({ onStartBattle }: IPlayersListProps) => {
	...
	return (
		<div className='grid auto-rows-auto grid-cols-[repeat(auto-fill,272px)] gap-5'>
			{pathname.includes('/finish') ? (
				<>
					{/* Winner */}
					<div>
						<div className={cls.player_card_bg}>
							<div
								className={clsx(
							...
							>
								<div className='!absolute -top-[24px] left-1/2 z-10 flex -translate-x-1/2 items-center gap-[6px]'>
									<WinnerBand />
								...
								<BgSnakeGreen className='absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2' />
								<div
								...
								<div className={cls.winning_price}>
									<div className={cls.winning_price_inner}>$ 1050.00</div>
								</div>
								<p className='mt-2 text-[12px] font-bold leading-4 text-[#237C67]'>
						...
						<div key={index}>
							<div className={cls.player_card_bg}>
								...
								>
									...
									<BgSnakeRed className='absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2' />
									<div
										className='absolute bottom-0 left-0 right-0 top-0'
										style={{
									...
									></div>
									<div className={cls.lossed}>
										<div className={cls.lossed_inner}>{t('case_battles.lossed').toUpperCase()}</div>
									</div>
								</div>
							</div>
							<div className={clsx(cls.player_title, 'mt-5 h-[66px] w-[272px] opacity-60')}>
						...
						<div className={clsx(cls.player_card_bg, '!h-[370px]')}>
							...
							>
								...
								<div className='mb-[14px] flex items-center justify-center gap-[3px]'>
									<div className={clsx(cls.winning, 'h-[38px] w-[27px] text-[24px] font-medium leading-4')}>
										<div className={clsx(cls.winning_inner, 'flex items-center justify-center')}>$</div>
									</div>
									<div className={clsx(cls.winning, 'h-[38px] w-[27px] text-[24px] font-medium leading-4')}>
										<div className={clsx(cls.winning_inner, 'flex items-center justify-center text-[#24FDBC]')}>5</div>
									</div>
									<div className={clsx(cls.winning, 'h-[38px] w-[27px] text-[24px] font-medium leading-4')}>
										<div className={clsx(cls.winning_inner, 'flex items-center justify-center text-[#24FDBC]')}>5</div>
									</div>
					...
					<div>
						<div className={cls.player_card_bg}>
							<div
								className={clsx(
									cls.player_card_bg_inner,
									'relative flex flex-col items-center justify-end gap-4 overflow-hidden py-[20px]'
								)}
							>
								<div className='absolute left-[12px] top-1/2 z-10 flex h-[210px] w-[30px] -translate-y-1/2 flex-col rounded-[100px] bg-[#0B0E15]'>
								...
								<Button
									classNames={{
										base: '!absolute left-1/2 -top-[2px] z-10 flex -translate-x-1/2 items-center gap-[6px] w-[106px] h-[33px]'
									}}
								>
									<svg
										width='106'
								...
								<Button
									...
									classNames={{
										base: clsx(cls.hexagon_btn, cls.sm, 'h-[36px] w-[120px] z-10'),
						...
						<div className={cls.player_card_bg}>
							...
							>
								...
								<div className='flex items-center gap-3'>
									<SmallAvatar icon='/images/avatars/2.jpg' />
									<IconCaseBattle className='h-6 w-6 fill-[#262E42]' />
									<svg
										width='48'
										height='48'
										viewBox='0 0 48 48'
					...
					<div>
						<div className={cls.player_card_bg}>
							...
							>
								...
								<p className='z-10 translate-y-12 text-[20px] font-[900] leading-4 text-white'>
									{t('case_battles.ready').toUpperCase()}
								</p>
							</div>
						</div>
						<div className={clsx(cls.player_title, cls.ready, 'mt-5 h-[66px] w-[272px]')}>
							<div className={clsx(cls.player_title_inner, 'flex items-center px-3 py-[9px]')}>
								<SmallAvatar icon='/images/avatars/2.jpg' />
