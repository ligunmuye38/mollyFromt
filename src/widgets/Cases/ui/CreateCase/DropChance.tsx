            ...
            <div className={clsx(cls.chance_item_inner, "p-[10px] flex gap-[10px]")}>
                ...
                <div className="flex flex-col justify-between flex-1 gap-0.5">
                    ...
                    <div className="flex gap-2 w-full">
                        <div className={clsx(cls.chance_item_btn, "w-[90px]")}>
                            <div className={clsx(cls.chance_item_btn_inner, "p-1.5 flex items-center")}>
                                <div className="bg-[#17E2A5] rounded-md text-[#141925] text-[14px] font-[900] py-[5px] px-[9px]">
                                    <div>%</div>
                                </div>
                        ...
                        <div className={clsx(cls.chance_item_active, "flex flex-1")}>
                            <div className={clsx(cls.chance_item_active_inner, "w-full flex justify-center items-center")}>
                                <div className="flex gap-0.5">
