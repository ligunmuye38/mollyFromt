...
import { IBadgeItem, ICaseItemType, IFarmItemType, IPagination, LiveFeedItem } from './types'
...
export const selectItems: ICaseItemType[] = [
	{
		id: 'case-1',
		title: 'FT',
		content: 'CHANCE',
...
// Accept progress
export const acceptItems: IFarmItemType[] = [
	{
		id: 'case-1',
		title: 'FT',
		content: 'CHANCE',
		...
		price: '456,05',
		type: 'yellow',
		pricesTitle: ['fn', 'mw', 'ft', 'ww'],
		prices: ['1928.84', '2304.02', '1399.98', '1029.90'],
		oods: ['0.247', '0.50896', '0.396', '0.667']
	},
	{
		id: 'case-2',
		title: 'FT',
