...
export const DepositHistoryListItem = ({ item }: DepositHistoryListItemProps) => {
	...
	return (
		<div className='flex items-center rounded-lg bg-[#111620] px-3 py-[10px]'>
			...
			<p className={'w-1/6 text-[#24FDBC]'}>{item.amount}</p>
			<p className={'w-1/6 text-[#E2B517]'}>{item.bonus}</p>
	...
	return (
		<>
			<div className='mb-2 flex w-full rounded-lg bg-[#1F2536] px-[15px] py-[9px] font-primary-bold text-[10px] text-[#5A6786]'>
				<span className='flex w-1/6 items-center justify-start uppercase'>{t('transaction_history_profile.id')}</span>
				<span className='flex w-1/6 items-center justify-start uppercase'>
				...
				<span className='flex w-1/6 items-center justify-start uppercase'>{t('transaction_history_profile.date')}</span>
				<span className='flex w-1/6 items-center justify-end uppercase'>{t('transaction_history_profile.status')}</span>
			</div>
